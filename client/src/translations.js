...
export const translations = {
  en: {
    ...
    deleteMeetingConfirm: "Are you sure you want to cancel the meeting?",
    deleteMeetingSuccess: "Meeting cancelled successfully!",
    deleteMeetingError: "You do not have permission to delete this meeting.",
    deleteMeetingUnauthorized: "You are not authorized to delete this meeting",
    ...
    subjectCourseCode: "Subject / Course Code",
    groupDescription: "Description",
    descriptionPlaceholder: "What is this group for? Share goals, meeting times, etc.",
    public: "Public",
    private: "Private",
    creating: "Creating...",
    subject: "Subject",
  ...
  he: {
    ...
    deleteMeeting: "ביטול פגישה",
    deleteMeetingConfirm: "האם אתה בטוח שברצונך לבטל את הפגישה?",
    deleteMeetingSuccess: "המפגש בוטל בהצלחה!",
    deleteMeetingError: "אין לך הרשאה למחוק פגישה זו",
    deleteMeetingUnauthorized: "אינך מורשה לבטל פגישה זו",
    ...
    noDescription: "לא צוין תיאור.",
    groupName: "שם הקבוצה",
    subjectCourseCode: "מקצוע / קוד קורס",
    groupDescription: "תיאור",
    descriptionPlaceholder: "בשביל מה הקבוצה? שתפו מטרות, זמני מפגשים וכו'.",
    public: "ציבורי",
    private: "פרטי",
    creating: "יוצר...",
    subject: "מקצוע",
    ...
    postNewNotice: "פרסם מודעה חדשה",
    postUpdate: "פרסם עדכון",
    noNoticesYet: "אין מודעות שפורסמו עדיין",
    by: "על ידי:",
    ...
    aiThinking: "חושב...",
    aiImprove: "שפר באמצעות AI",
    improving: "משפר...",
    aiSuggestion: "הצעת ה-AI",
